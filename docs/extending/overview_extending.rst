...
.. Copied from edx-documentation\en_us\developers\source\extending_platform\extending.rst

**********************************
Comparing extension methods
**********************************

This matrix will help you choose the extension methods that are suitable for your project needs and development environment.
...
However, the platform UI is slowly being replaced by new React-based "micro-frontends" (MFEs). See :ref:`Micro-frontend applications (MFEs)`. A different approach is required for theming MFEs (see `Theming Micro-frontends`_).
