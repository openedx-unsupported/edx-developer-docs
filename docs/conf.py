...
project_title = 'Developer Documentation'
...
#
# html_title = 'edx-developer-docs v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Developer Documentation',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_developer_docs'),
                os.path.join(root_path, 'edx_developer_docs/migrations')])
